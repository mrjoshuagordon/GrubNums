...
$test = get_setting_limit($session_user_id);
...
<td class="filter-data">
<select name = 'sort-id' onchange="change()" width="100" style="width: 100px" >
...
<td class="filter-data">
 <select name = 'rating-id' onchange="change()" width="100" style="width: 100px" >
...
<td class="filter-data">  <select name = 'location-id' onchange="change()" width="100" style="width: 100px" >
